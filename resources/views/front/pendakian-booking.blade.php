...
<body>
  ...
  <main class="site-main">
    ...
    <!-- ================ start banner form ================= --> 
    <form method="post" action="{{ route('cekboking') }}" class="form-search form-search-position">
        @csrf
      <div class="container">
        <div class="row">
          <div class="col-lg-6 gutters-19">
            <div class="form-group">
                <input type="text" class="form-control" name="nama_wisata" id="nama_wisata" value="{{ $r->nama_wisata }}" placeholder="{{ $r->nama_wisata }}">
            </div>
          </div>
          <div class="col-lg-6 gutters-19">
            <div class="row">
              <div class="col-sm">
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" name="tgl_booking" class="form-control datepicker" placeholder="Tgl. pendakian" id="datepicker-autoclose">
